...
<?php if ($the_query->have_posts()): ?>
    <div class="pi-post-related-section"> 
        <div class="container d-flex justify-content-between align-items-end">
            <h2>Related articles</h2>

            <div class="pi-post-related-section__navigation d-flex justify-content-end align-items-center">
        ...
        <div class="pi-post-related-section__carousel"> 
