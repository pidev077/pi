...
$tag_desc     = term_description( $current_tag->term_id, 'post_tag' );
    ...
    <div class="archive-breadcrumb-bar">
        <div class="container">
            <nav class="post-breadcrumb" aria-label="breadcrumb">
                ...
                <span aria-current="page"><?= esc_html( $tag_name ) ?></span>
            </nav>
        </div>
    </div>
    ...
    <section class="archive-hero archive-hero--centered">
        <div class="container">
            <h1 class="archive-hero__title">
                <span class="archive-hero__title-prefix"><?= esc_html__( 'tag:', 'pi' ) ?></span>
                <?= esc_html( $tag_name ) ?>
            </h1>
            <?php if ( $tag_desc ) : ?>
                <div class="archive-hero__desc"><?= wp_kses_post( $tag_desc ) ?></div>
            <?php endif; ?>
        </div>
    </section>
            ...
            <div class="archive-posts__header">
                <div class="archive-posts__heading">
                    <h2 class="archive-posts__title">
                        <?= esc_html__( 'Bài viết với tag:', 'pi' ) ?>
                ...
                <div class="row g-4 archive-posts__grid">
                    <?php while ( have_posts() ) : the_post(); ?>
                        <div class="col-md-6 col-lg-4">
                            <?php pi_blog_card( get_post(), false ); ?>
                        </div>
                    <?php endwhile; ?>
                </div>
